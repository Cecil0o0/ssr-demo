...
// 生成style相关loader
export const generateStyleLoader = function generateStyleLoader(type = 'css') {
  let loaders = [
    'postcss-loader'
  ]
  ...
  loaders.unshift(ENABLE_CSS_EXTRACT && HOST_PLATFORM === 'web-standalone' ? ExtractCssChunks.loader : 'vue-style-loader')
